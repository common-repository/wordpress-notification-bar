...
License: GPLv2
Copyright 2012  John Turner ( twitter : @johnturner)
*/
...
define( 'SEED_WNB_VERSION', '1.3.11' ); // Plugin Version Number. Recommend you use Semantic Versioning http://semver.org/
